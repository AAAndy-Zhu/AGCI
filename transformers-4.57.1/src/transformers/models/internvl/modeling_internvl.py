        ...
        **kwargs: Unpack[TransformersKwargs],
        ...
        if pixel_values is not None:
            ...
            if only_return_image_embeds:
                ...
                # print(orig_shape)
                flat_image_features = image_features.reshape(-1, orig_shape[-1])
                return flat_image_features
            ...
            if global_context_broadcast_lambda > 0.0:
                ...
                # print(orig_shape)
                flat_image_features = image_features.reshape(-1, orig_shape[-1])
                # print(flat_image_features)
                flat_image_features = self.adaptive_global_context_broadcast(
                        flat_image_features,
                        lambda_scale=0.5
                    )
                # print(flat_image_features)
                ...
                image_features = flat_image_features.reshape(orig_shape)
            # print(image_features)
            # exit()
